...
.perfil_user-grid .perfil_user-span-2 { grid-column: 1 / -1; }
...
.perfil_user-dato-row { margin-bottom: 14px; }
...
.perfil_user-stat-icon.perfil_user-jornadas { background: #e8f5e9; color: #2e7d32; }
.perfil_user-stat-icon.perfil_user-centros  { background: #fff3e0; color: #e65100; }
...
.perfil_user-stat-mini-chart { margin-left: auto; opacity: .5; }
...
.perfil_user-hist-icon.perfil_user-jornadas { background: #ede7f6; color: #5e35b1; }
.perfil_user-hist-icon.perfil_user-centros  { background: #fce4ec; color: #c62828; }
...
.perfil_user-hist-empty { font-size: .82rem; color: #adb5bd; }
.perfil_user-hist-table { font-size: .82rem; margin: 0; }
.perfil_user-hist-table td, .perfil_user-hist-table th {
    padding: 6px 8px;
    border-color: #f0f0f0;
...
@media (max-width: 768px) {
    .perfil_user-grid { grid-template-columns: 1fr; }
    .perfil_user-grid .perfil_user-span-2 { grid-column: 1; }
}
</style>
<?= $this->endSection() ?>
