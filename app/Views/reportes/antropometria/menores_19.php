  ...
  <main class="rep_ad_main">
    ...
    <div class="rep_ad_topbar">
      ...
      <div class="rep_ad_topbar_actions">
        <a href="<?= site_url("jornadas/{$jornadaId}/reportes/antropometria/menores-19/excel") ?>" class="rep_ad_btn rep_ad_btn_primary">
    ...
    <section class="rep_ad_kpi_grid">
      ...
      <article class="rep_ad_kpi_card">
        ...
        <div>
          <div class="rep_ad_kpi_value"><?= esc((string)$contadores['menores_5']) ?></div>
          <div class="rep_ad_kpi_title">&lt; 5 años</div>
        </div>
      </article>
      ...
      <article class="rep_ad_kpi_card">
        ...
        <div>
          <div class="rep_ad_kpi_value"><?= esc((string)$contadores['entre_5_19']) ?></div>
          <div class="rep_ad_kpi_title">5 - 19 años</div>
        </div>
      </article>
      ...
      <?php foreach ($riesgos as $key => $cfg): ?>
        ...
        <article class="rep_ad_kpi_card">
          ...
          <div>
            ...
            <div class="rep_ad_kpi_subtitle"><?= esc(rep_ad_pct((int)($semaforo[$key] ?? 0), (int)$pctBase)) ?>%</div>
          </div>
        </article>
      <?php endforeach; ?>
    </section>
...
<div class="rep_ad_table_wrapper">
  <table id="tablaMenores" class="table table-hover align-middle mb-0" style="font-size:.83rem;">
    ...
    <tbody>
      <?php if (empty($datos)): ?>
        <tr>
          <td colspan="18" class="rep_ad_empty">
